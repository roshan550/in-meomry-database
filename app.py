...
if current_viz:
    ...
    # st.write("Debug: Current data state:", st.session_state.db.get_all_data())
    # st.write("Debug: Current data state:", st.session_state.db.get_all_data())
...
if st.session_state.previous_structure != structure:
    try:
        # st.write("Debug: Transitioning from", st.session_state.previous_structure, "to", structure)
        # st.write("Debug: Transitioning from", st.session_state.previous_structure, "to", structure)
        # st.write("Debug: Transitioning from", st.session_state.previous_structure, "to", structure)
        # st.write("Debug: Transitioning from", st.session_state.previous_structure, "to", structure)
        ...
        if source_viz and target_viz:
                    ...
                    # st.write("Debug: Source Visualization:", source_viz)
                    # st.write("Debug: Target Visualization:", target_viz)
                    # st.write("Debug: Source Visualization:", source_viz)
                    # st.write("Debug: Target Visualization:", target_viz)
                    # st.write("Debug: Source Visualization:", source_viz)
                    # st.write("Debug: Target Visualization:", target_viz)
...
main_viz = st.session_state.db.get_current_visualization()
if main_viz:
    st.graphviz_chart(main_viz, use_container_width=True)
else:
    st.info("No data to visualize yet. Try adding some values using the Insert operation.")
...
with col3:
    if st.button("Execute", use_container_width=True):
        ...
        if success:
            # st.write("Debug: Operation successful:", result_msg)
            # st.write("Debug: Operation successful:", result_msg)
            # st.write("Debug: Operation successful:", result_msg)
